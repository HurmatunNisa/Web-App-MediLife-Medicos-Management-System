...
<html lang="en" dir="ltr">
  ...
  <meta charset="utf-8">
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> <!-- Use the correct version of jQuery -->
  ...
  <body>
    <div class="container">
      ...
      <div id="login-form" class="card m-auto p-2">
        <div class="card-body">
          <form name="login-form" class="login-form" action="session.php" method="post" onsubmit="login(); return false;">
            <div class="logo">
          ...
          <div name="login-form" class="login-form">
            ...
            <div id="email-number-fields">
              ...
              <div class="input-group form-group">
                ...
                <input id="contact_number" type="number" class="form-control" placeholder="enter contact number" onkeyup="validateContactNumber();" required>
              </div> <!-- input-group class -->
