    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('cubes', 'Manage Medicines Stock', 'Manage Existing Medicine Stock');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            &emsp;<input type="text" class="form-control" id="by_generic_name" placeholder="By BATCH ID" onkeyup="searchMedicineStock(this.value, 'GENERIC_NAME');">
            ...
            <div class="table-responsive">
            	<table class="table table-bordered table-striped table-hover">
                   ...
                   <th style="width: 5%;">ID</th>
                    ...
                    <th style="width: 5%;">Expiry Date(mm/yy)</th>
                    <th style="width: 10%;">Batch ID</th>
                    <th style="width: 7%;">Qty.</th>
                    <th style="width: 14%;">MRP</th>
                    <th style="width: 8%;">RATE</th>
                    <th style="width: 1%;">Min_Stock</th>
                    <th style="width: 1%;">Max_Stock</th>
                    <th style="width: 1%;">Stock_In_Date</th>
