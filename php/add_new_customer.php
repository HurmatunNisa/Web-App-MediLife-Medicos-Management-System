<?php
  ...
  if($con) {
    ...
    if($row)
      ...
      $query = "INSERT INTO customers (NAME, CONTACT_NUMBER, ADDRESS, EMAIL, GENDER, DOCTOR_NAME, DOCTOR_ADDRESS) VALUES('$name', '$contact_number', '$address', '$email', '$gender', '$doctor_name', '$doctor_address')";
      $result = mysqli_query($con, $query);
      if(!empty($result))
  			echo "$name added...";
  		else
