<?php
  ...
  if($con) {
    ...
    if(isset($_GET['action']) && $_GET['action'] == "medicines_id")
      getVVValue($con, $_GET['action'], "PRODUCT_ID");
    ...
    if(isset($_GET['action']) && $_GET['action'] == "suppliers_contact")
      getVValue($con, $_GET['action'], "CONTACT_NUMBER");
  }
  ...
  function getVValue($con, $action, $column) {
    $name = $_GET['name'];
  ...
  function getVVValue($con, $action, $column) {
    $name = $_GET['name'];
