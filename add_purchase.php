...
<html lang="en" dir="ltr">
 ...
 <!-- adding extra div for medicine/product -->
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="suppliers_contact">Supplier Contact :</label>
              <input id="suppliers_contact" type="number" class="form-control" name="suppliers_contact" placeholder="Supplier Contact" disabled>
            </div>
          ...
          <!-- supplier details content end -->
           ...
           <div class="col col-md-12">
            <hr class="col-md-12" style="padding: 0px; border-top: 2px solid ;color:red;">
          </div>
