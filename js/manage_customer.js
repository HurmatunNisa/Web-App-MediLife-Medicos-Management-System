...
function updateCustomer(id) {
  ...
  if(!validateName(customer_name.value, "name_error"))
    ...
    xhttp.open("GET", "php/manage_customer.php?action=update&id=" + id + "&name=" + customer_name.value + "&contact_number=" + contact_number.value + "&address=" + customer_address.value + "&email=" + customer_email.value + "&gender=" + customer_gender.value + "&doctor_name=" + doctor_name.value + "&doctor_address=" + doctor_address.value, true);
    xhttp.send();
  }
}
