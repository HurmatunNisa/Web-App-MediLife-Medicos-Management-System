      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            <input type="text" class="form-control" id="" placeholder="By Customer Name" onkeyup="searchCustomer(this.value);">
          </div>
          ...
          <div class="col col-md-12 table-responsive">
            <div class="table-responsive">
            	<table class="table table-bordered table-striped table-hover">
                    ...
                    <th style="width: 11%;">Doctor's Name</th>
                    <th style="width: 13%;">Doctor's Address</th>
